<div class="space-y-8 rounded-xl bg-[#0f172a] p-8">
    <div class="grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
        ...
        >
            <div class="flex h-full flex-col justify-between">
                <div class="flex items-center justify-between">
                    <p class="text-xs font-bold uppercase tracking-[0.1em] text-slate-200">AI Pal Intelligence</p>
                ...
                <div>
                    <p class="text-4xl font-bold text-slate-100">94%</p>
        ...
        >
            <div class="flex h-full flex-col justify-between">
                <div class="flex items-center justify-between">
                    <p class="text-xs font-bold uppercase tracking-[0.1em] text-slate-200">Job Portal</p>
                ...
                <div>
                    <p class="text-4xl font-bold text-slate-100">128</p>
        ...
        >
            <div class="flex h-full flex-col justify-between">
                <div class="flex items-center justify-between">
                    <p class="text-xs font-bold uppercase tracking-[0.1em] text-slate-200">Services</p>
                ...
                <div>
                    <p class="text-4xl font-bold text-slate-100">42</p>
        ...
        >
            <div class="flex h-full flex-col justify-between">
                <div class="flex items-center justify-between">
                    <p class="text-xs font-bold uppercase tracking-[0.1em] text-slate-200">Locations</p>
                ...
                <div>
                    <p class="text-4xl font-bold text-slate-100">16</p>
